...
public class SummaryClient {
    ...
    private String buildPrompt(List<Incident> incidents, LocalDateTime from, LocalDateTime to,
        ...
        return """
                ...
                Твоє завдання: написати КОРОТКЕ (до 15 речень) резюме зміни звичайним текстом українською мовою, призначене для керівництва або чергової зміни, що приходить. Резюме має:
                ...
                - ОБОВ'ЯЗКОВО УНИКАЙ в українській русизмів. ЖОДНИХ "ы", "э", "ё", "ъ".
