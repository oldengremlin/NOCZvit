...
public class SummaryClient {
    ...
    private String buildPrompt(List<Incident> incidents, LocalDateTime from, LocalDateTime to,
        ...
        return """
                ...
                - Слово "датацентр"/"у датацентрі" вживай ВИКЛЮЧНО для подій із блоку "ПОДІЇ ОБЛАДНАННЯ ДАТАЦЕНТРУ" (майданчик Прахових 50). Для решти локацій — це звичайні виноси мережі, а не датацентр: пиши "на виносі", "на локації" або "на майданчику", НІКОЛИ "у датацентрі".
