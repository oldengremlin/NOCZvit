...
public class Config {
    ...
    private void printHelp() {
        ...
        System.err.println("  mail.hostname=smtp.***REMOVED***");
        ...
        System.err.println("  email.from=noczvit@***REMOVED***");
        System.err.println("  email.replyTo=support@***REMOVED***");
        System.err.println("  email.to=duty-report@***REMOVED***,***REMOVED***");
        System.err.println("  email.toDebug=olden@***REMOVED***");
