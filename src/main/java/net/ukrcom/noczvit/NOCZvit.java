    ...
    public static void main(String[] args) throws MessagingException, IOException {
        ...
        try {
            ...
            StringBuilder message = new StringBuilder(
                    ...
                    + "h4.resilience-host-sub{font-size:12px;color:#4a148c;background:#e8eaf0;border-left:4px solid #7b1fa2;margin:10px 0 4px 16px;padding:4px 10px}"
                    + ".resilience-host-body{margin-left:24px}"
