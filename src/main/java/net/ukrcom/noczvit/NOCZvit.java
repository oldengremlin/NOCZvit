    ...
    public static void main(String[] args) throws MessagingException, IOException {
        ...
        try {
            ...
            StringBuilder message = new StringBuilder(
                    ...
                    + "h2.trap-title{font-size:16px;color:#1b5e20;background:#e8f5e9;border-left:4px solid #2e7d32;margin:8px 0 4px;padding:5px 10px}"
                    + "h3.trap-device{font-size:13px;color:#1b5e20;background:#e8f5e9;border-left:4px solid #2e7d32;margin:12px 0 4px;padding:5px 10px}"
