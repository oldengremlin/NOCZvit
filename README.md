...
- М'який вердикт («ймовірно протримали довше» / «ймовірно, протримали не довше за клієнтів») з'являється лише на двох однозначних краях — усі відомі порти впали раніше вузла, або жоден не впав раніше (усі лишались активними на момент падіння вузла); лише факт, без рекомендацій — в іншому разі рядок узагалі порожній, висновок за інженером NOC
