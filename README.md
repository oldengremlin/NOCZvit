...
Результат — `target/NOCZvit-1.4.0.jar` (uber-JAR з усіма залежностями).

## Запуск

```bash
java -jar target/NOCZvit-1.4.0.jar [OPTIONS]
```
...
```bash
java -jar target/NOCZvit-1.4.0.jar --debug --no-incidents
```
