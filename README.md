...
Результат — `target/NOCZvit-1.4.5.jar` (uber-JAR з усіма залежностями).

## Запуск

```bash
java -jar target/NOCZvit-1.4.5.jar [OPTIONS]
```
...
```bash
java -jar target/NOCZvit-1.4.5.jar --debug --no-incidents
```
