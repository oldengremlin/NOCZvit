...
Після декодування `expandAbbreviations()` розгортає відомі абревіатури незалежно від регістра: `AVR` → «автоматичний ввід резерву» — щоб Claude розумів контекст без доменних знань про обладнання.
