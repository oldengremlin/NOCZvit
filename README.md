...
Результат — `target/NOCZvit-1.11.3.jar` (uber-JAR з усіма залежностями).

## Запуск

```bash
java -jar target/NOCZvit-1.11.3.jar [OPTIONS]
```
...
```bash
java -jar target/NOCZvit-1.11.3.jar --debug --no-incidents
```
