...
- Слово «датацентр» дозволене лише для подій із блоку ПОДІЇ ОБЛАДНАННЯ ДАТАЦЕНТРУ (майданчик Прахових 50); решта локацій — звичайні виноси мережі («на виносі» / «на локації»)
