...
Результат — `target/NOCZvit-1.4.4.jar` (uber-JAR з усіма залежностями).

## Запуск

```bash
java -jar target/NOCZvit-1.4.4.jar [OPTIONS]
```
...
```bash
java -jar target/NOCZvit-1.4.4.jar --debug --no-incidents
```
